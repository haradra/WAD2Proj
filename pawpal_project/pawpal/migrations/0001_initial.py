# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-03-08 09:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('madeBy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='madBy', to=settings.AUTH_USER_MODEL)),
                ('toWho', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='toWho', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
